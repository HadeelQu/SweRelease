        ...
        <table style="border:1px solid #EEE; width:720px" >
            <caption> Fill Admin's information </caption>
                ...
                <tr>
                    ...
                    <td><input type="password" class="form-control" id="password" name="password" pattern="[A-Za-z0-9_]*{3,15}" title="enter 3-15 digits Only" placeholder="enter passward" required style="width:400px;"><br></td>
                </tr>
